...
---
The weights of this dataset range from 0.2298 to 3.0386.
---
2. What does it mean when a respondent has a weight of 0.23? What about 3.04?
---
It means that the voice of one respondent is counted as 0.23 and as 3.04.
---
3. Why might some respondents be weighted more heavily than others?
---
If the respondents are a part of a subgroup that is overrepresented in the sample, they will be weighted more lightly than others. On the contrary, if the respondents are a part of an underrepresented subgroup, they will be weighted more heavily. All of this is done to make the proportion of sub-groups in the survey sample match that of the real population as closely as possible.    
---
...
---
The rarely/never voters who answer that they are going to vote this time.
---
2. How might these differences affect reporting on likely voter turnout?
---
Without weighting, the reporting may miscount the number of voter turnout for certain candidates, which could affect the predicted election result, especially in a close race election.  
---
...
---
These differences exist because some subgroups are likely to participate in the survey more or less than others, making their representation in a survey sample does not match that of the real population. From this dataset, subgroups like rarely voters who decide to vote this time are overrepresented as their weighted result is less than the unweighted result, while rarely voters who decide not to vote this time are underrepresented as their weighted result is more than the unweighted result, which kind of makes sense because they are unlikely to participate in the survey. 
---
