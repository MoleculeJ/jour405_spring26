...
---
I think this data is not a hundred percent normal distribution as it is skewed to the right a little, but it's extremely close, as the peak contribution is close to the mean of the entire dataset, and (estimated roughly by looking) two-thirds of all data points fall within the range of standard deviation.   
---
