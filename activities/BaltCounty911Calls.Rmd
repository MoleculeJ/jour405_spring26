...
ANSWER HERE
---
- The number of calls seemed to peak in early October and probably on New Year's Day. 
- The other days with the usual high volume of calls seemed to cluster around Mar to May, and in July.
- Hence, the line that could highlight the unusual days might slightly go up at the beginning of the year and then peak in July, October, and the new year.  
- The number seemed to subside toward the beginning of 2023, which was quite a contrast to what happened at the beginning of 2022, when the number rose. 
---
```{r daily-calls-plot}
...
ANSWER HERE
---
In task 3, I only spotted 7 days with an unusually high volume of calls just by looking, but with Z-score as the criterion, there are 11, and the visualization makes it clearer to notice.
---
```{r plot-unusual-days}
...
ANSWER HERE
---
I think we could describe those days in terms of days with unusually high volume of calls, and instead of wording "z-score," we may use a percentage instead. As the range of 2 SDs includes about 95% of the dataset, we could describe days that have a z-score falling outside this range as "...there are only 5% percent of days that have this high or low volume of calls..."
---
...
ANSWER HERE
---
I think the promising angles here are days with the most Z-score, and the next step should be finding out what happened on those days. We could point out to the editor that these days may coincide with some significant events or could reveal some pattern about drug use or drug distribution, like July 14 and July 22, which have the second and third highest z-scores and were apart for just a week. 
---
