...
---
For the overview, the highest total crime rate in Maryland occurred in 1981, and the lowest happened in 2020. So we can generally conclude that Maryland today is safer. This pattern also somewhat matches the ones of violent crime and property crime, with the lowest crime rate appearing in 2020. However, while the highest crime rate of property crime occurred in the 1980s, the highest of violent crime happened in the 1990s, which deviates from the general trend.       
---
