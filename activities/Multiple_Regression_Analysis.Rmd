...
ANSWER HERE
---
Yes, I think this model is somewhat useful due to the overview of all indicators. The very low p-value indicates that this model is statistically significant or the correlation is very unlikely to exist due to chance, and the 58.28% of adjusted R-squared indicates that this model, by factoring in all predictors, can explain more than half of the portion of variability in the outcomes. Hence, I would say that this model is generally useful.    
---
...
ANSWER HERE
---
The Point Scored has the most impact on Wins, while the Yard Gained does not seem to have that much impact on the Wins. The correlation value is 0.44, the p-value is 0.34 (correlation is likely due to chance), and the coefficient is -0.0013, which is very small, so I think Yard Gained doesn't affect much (or barely at all) on the wins outcome.
---
...
---
In the report, I think I would refer to this model as a statistical method that helps us estimate how much the combination of these three factors - Yards Gained, Takeaways, and Points Scored - could affect the win outcome 
---
