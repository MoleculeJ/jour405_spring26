...
---
The home values seem to rise, impacted by the new light rail, with recent sales averaging about $304.5K, 6.8% higher than the previous average of $285K. A statistical test suggests that this increase is unlikely because of chance alone (p-value = 0.00018%), which supports the local officials' claim. However, as this relationship between home prices and new light rail could be just a correlation, further analysis might be needed to identify whether other factors like the increasing number of people in the neighborhood or the shifting in demand are at play.    
---
